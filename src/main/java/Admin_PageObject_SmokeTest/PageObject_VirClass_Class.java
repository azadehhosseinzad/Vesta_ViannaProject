...
public class PageObject_VirClass_Class {
	...
	@FindBy(xpath="/html/body/div[5]/div/div[3]/div[1]/div/div/div/div/div[2]/div/span[2]/div/div/div/div[2]/ul/li[6]") 
	WebElement createvir;
	...
	public void CraeteVirCalss(WebDriver driver,String title,String capacity,String Titlevirclass,String startdate,String starttime,String duration) throws InterruptedException {
