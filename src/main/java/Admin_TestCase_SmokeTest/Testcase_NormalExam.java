...
import Admin_PageObject_SmokeTest.PageObject_NormalExam;
...
public class Testcase_NormalExam {

	WebDriver driver;
  @Test(dataProvider="InsertNormalExamMCH_TC1",dataProviderClass= DataProviderMinimal.class)
  public void f(String title,String code,String passscore,String startdate,String fromtime,String EndDate,String totime,
			String duration) throws InterruptedException, ParseException, IOException {
	  
	  PageObject_NormalExam Newexam=PageFactory.initElements(driver, PageObject_NormalExam .class);
	  Newexam.AddNewNormalExam(driver, title, code, passscore, startdate, fromtime, EndDate, totime, duration);
